...
def load_raster_as_xarray(
    filename: str | os.PathLike | rasterio.io.DatasetReader | rasterio.vrt.WarpedVRT,
    parse_coordinates: bool | None = None,
    chunks: int | Tuple | Dict | None = None,
    ...
    **open_kwargs,
    ...
    parse_coordinates : bool | None, default = None
        Whether to parse the x and y coordinates out of the file's
        ``transform`` attribute or not. The default is to automatically
        parse the coordinates only if they are rectilinear (1D).
        It can be useful to set ``parse_coordinates=False``
        if your files are very large or if you don't need the coordinates.
    chunks : int | Tuple | Dict | None, default = None
    ...
    open_kwargs : kwargs | None, default = None
        Optional keyword arguments to pass into :func:`rasterio.open`.


    Returns
    -------
    :obj:`xr.DataArray` | :obj:`xr.Dataset`
        Loaded data.

    References
    ----------
    .. [1] `open_rasterio <https://corteva.github.io/rioxarray/stable/rioxarray.html>`_
...
def _handle_xarray_memory(
    data_obj: xr.Dataset | xr.DataArray, make_temp: bool = False
...
def _check_dask_array(original_map: xr.DataArray | xr.Dataset) -> bool:
    """
