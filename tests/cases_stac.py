...
def case_stac_api_call(url, collection, bbox, time, bands, time_aggregate, nodata_fill, expected_df):
...
def case_stac_api_call_fail(url, collection, bbox, time, bands, time_aggregate, nodata_fill, exceptions):
